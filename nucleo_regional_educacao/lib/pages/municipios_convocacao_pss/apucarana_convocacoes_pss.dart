...
import 'package:nre_tcc_feitep/components/cidades_dropdown.dart';
import 'package:nre_tcc_feitep/components/distribuicao_pss_dropdown.dart';
...
import '../../components/distribuição_por_municipio_dropdown.dart';

class Apucarana_convocacao_pss extends StatefulWidget {
  const Apucarana_convocacao_pss({Key? key}) : super(key: key);

  @override
  _Apucarana_convocacao_pssState createState() =>
      _Apucarana_convocacao_pssState();
}

class _Apucarana_convocacao_pssState extends State<Apucarana_convocacao_pss> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Padding(
                              ...
                              child: Text('Convocações por Município:',
                                  style:
                                      TextStyle(fontWeight: FontWeight.bold)),
                            ),
                            Center(
                              child: Distribuicao_pss_dropdown(),
                            ),
                            Divider(
                              color: Colors.black,
                              indent: 20,
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    AvisosNreComponent(
                                        label: "Documentos Para a Contratação",
                                        onTapped: () => {
                                              launchUrl(Uri.parse(
                                    ...
                                    AvisosNreComponent(
                                        ...
                                        image:
                                            'assets/images/edital_anterior48.png'),
                                    AvisosNreComponent(
                                        label: "Sistema PSS",
                                        onTapped: () => {
                                              launchUrl(Uri.parse(
                                                  'http://www.pss.pr.gov.br/pss/acesso.do;jsessionid=CD0E6CF239E99446B8CA70CEF4BC369E'))
                                            },
                                        image: 'assets/images/sistema48.png'),
                                  ],
                                ),
                              ),
                            ),
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8.0),
                                child: Text(
                                    'O PSS é um processo seletivo simplificado, realizado pela Secretaria de Estado da Educação para a contratação temporária de professores, pedagogos, intérprete de libras. Sua contratação ocorre através de Regime Especial - CRES, com data de término já determinada, sendo regulamentada pela Lei Complementar n.º 108/2005 e pelo Decreto Estadual n.º 4.512/2009.'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                              child: Padding(
                                ...
                                child: Text(
                                    'Tal processo é realizado de acordo com as normas estabelecidas por editais, que são publicados no site da Secretaria de Estado, cujo link pode ser encontrado no topo desta página'),
                              ),
                            ),
                            Divider(
                              color: Colors.black,
