...
class Apucarana_estrutura extends StatefulWidget {
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Center(
                                child: Text("Estrutura e Funcionamento",
                                    style: TextStyle(
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8.0),
                                child: Text(
                                    'O setor de Estrutura e Funcionamento tem por finalidade dar suporte as instituições escolares no cumprimento da legislação educacional vigente, orientando e verificando a Autorização de Funcionamento e o Credenciamento para a oferta da Educação Básica junto ao Sistema Estadual de Ensino, bem como a autorização de cursos, renovação de autorização, reconhecimento de curso, renovação de reconhecimento, mudança de entidade mantenedora, alteração de denominação da entidade mantenedora, mudança de endereço, mudança de denominação da Instituição de Ensino, Regimento Escolar, matriz curricular, calendário escolar, cessação de curso ou de Instituição de Ensino.'),
                              ),
                            ),
                            const Padding(
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                    'Luciane Maria Jonas | luciane_jonas@escola.pr.gov.br | (43) 3420-1621'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                    'Sueli da Silva Martins | suelimartins@escola.pr.gov.br | (43) 3420-1619'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                    'Suzana Aparecida Sampaio | suzanaasampaio@escola.pr.gov.br | (43) 3420-1621'),
                              ),
                            ),
                            const Divider(),
                            Padding(
