...
class Apucarana_Legislacao_escolar extends StatefulWidget {
                          ...
                          children: [
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8.0),
                                child: Text(
                                    'Ao Setor de Legislação Escolar do NRE de Apucarana compete orientar, homologar e emitir Parecer de Legalidade junto às Instituições de Ensino sobre: Projeto Político Pedagógico, Regimento Escolar, Calendário Escolar, Matrizes Curriculares e Conselho Escolar.'),
                              ),
                            ),
                            const Padding(
