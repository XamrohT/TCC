...
class Apucarana_atribuicao_e_funcoes extends StatefulWidget {
  const Apucarana_atribuicao_e_funcoes({Key? key}) : super(key: key);

  @override
  _Apucarana_atribuicao_e_funcoesState createState() =>
      _Apucarana_atribuicao_e_funcoesState();
}

class _Apucarana_atribuicao_e_funcoesState
    extends State<Apucarana_atribuicao_e_funcoes> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    AvisosNreComponent(
                                        label: "Distribuição de aulas",
                                        onTapped: () => {
                                              launchUrl(Uri.parse(
                                                  'https://www.educacao.pr.gov.br/Pagina/Distribuicao-de-Aulasr'))
                                            },
                                        image:
                                            'assets/images/distribuicao_aulas48.png'),
                                    AvisosNreComponent(
                            ...
                            const Padding(
                              ...
                              child: Text(
                                  'Distribuição de Aulas/Funções* por Município',
                                  style:
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8.0),
                                child: Text(
                                    '* Funções: Professor e Professor Pedagogo'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                              child: Padding(
                                ...
                                child: Text(
                                    '** Editais somente de Convocação de Títulos PSS - Fase I devem ser desconsiderados pelos servidores efetivos QPM e PSS já contratados ou que já tenham cumprido esta fase do processo.'),
                              ),
                            ),
                            Center(
                              child: CidadesDropdown(),
                            ),
                            Divider(
                              color: Colors.black,
                              indent: 20,
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8.0),
                                child: Text(
                                    '* Funções: Auxiliar de Serviços Gerais ou Assistente Administrativo'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                    '** Editais somente de Convocação de Títulos PSS - Fase I devem ser desconsiderados pelos servidores efetivos QFEB e PSS que já tenham cumprido esta fase do processo'),
                              ),
                            ),
                            Center(
                              child: Distribuicao_por_municipio_Dropdown(),
                            ),
                            Divider(
                              color: Colors.black,
                              indent: 20,
