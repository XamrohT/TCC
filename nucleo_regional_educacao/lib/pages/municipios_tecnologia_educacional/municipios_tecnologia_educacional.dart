...
class Apucarana_tecnologia_educacional extends StatefulWidget {
  const Apucarana_tecnologia_educacional({Key? key}) : super(key: key);

  @override
  _Apucarana_tecnologia_educacionalState createState() =>
      _Apucarana_tecnologia_educacionalState();
}

class _Apucarana_tecnologia_educacionalState
    extends State<Apucarana_tecnologia_educacional> {
                          ...
                          children: [
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8.0),
                                child: Text(
                                    'À Coordenação Regional de Tecnologia na Educação (CRTE), composta de Técnicos Pedagógicos e de Suporte, compete instituir mecanismos de formação e de supervisão do trabalho pedagógico com as tecnologias de informação e comunicação nas escolas públicas estaduais de sua área de abrangência, com vistas à utilização dos recursos tecnológicos disponíveis, bem como atender as demandas de manutenção e adequação do parque tecnológicos das escolas por meio de suporte técnico.'),
                              ),
                            ),
                            const Padding(
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                    'Renata Andressa Costa da Silva | renata_costa@escola.pr.gov.br | (43) 3420-1638'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text('Assessores em Tecnologia'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                    'André Mateus Guilherme | andre.guilherme@escola.pr.gov.br | (43) 3420-1637'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                    'Luís Aurélio Surek de Souza | luis.souza3@escola.pr.gov.br | (43) 3420-1658'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                    'Nivaldo Lopes Andrade | nivaldolopes@escola.pr.gov.br | (43) 3420-1659'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                    'Euvaldo Pereira da Silvade | euvaldosilva@escola.pr.gov.br | (43) 3420-1658'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                    'Rogério Assis Colombo | rogeriocolombo@escola.pr.gov.br | (43) 3420-1639 '),
                              ),
                            ),
                            const Divider(),
                            Padding(
