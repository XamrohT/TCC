                          ...
                          children: [
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                    'Maria de Fátima dos Santos de Oliveira | santosoliveira.naria1511@escola.pr.gov.br | (43) 3420-1669'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                    'Fabíola Heil de Araújo Barros | fabiolaheil@seed.pr.gov.br | (43) 3420-1668'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text(
                                    'Wanessa Guimarães Garcia | wanessaguimaraes@seed.pr.gov.br | (43) 3420-1669'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text('Distribuição de Aulas'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                            ...
                            const Expanded(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(8),
                                child: Text('Movimentação de Pessoal'),
                              ),
                            ),
                            const Expanded(
                              flex: 0,
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    AvisosNreComponent(
                                        label: "Documentos necessários PSS",
                                        onTapped: () => {
                                              launchUrl(Uri.parse(
                                    ...
                                    AvisosNreComponent(
                                        label: "Sistema de Assistência à Saúde",
                                        onTapped: () => {
                                              launchUrl(Uri.parse(
